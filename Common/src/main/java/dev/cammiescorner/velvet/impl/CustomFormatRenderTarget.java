 ...
 */
public class CustomFormatRenderTarget {
	public static final String FORMAT_KEY = "velvet:format";
	...
	public static @Nullable CustomFormatRenderTarget.TextureFormat getCustomFormat() {
		return FORMAT.get();
	}
